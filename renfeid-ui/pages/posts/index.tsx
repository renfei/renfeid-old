...
export const getServerSideProps: GetServerSideProps = async (context: any) => {
    ...
    const result: APIResult<ListData<PostVo>> = await api.getPosts(convertToHeaders(context.req.headers, context.req.socket.remoteAddress), undefined, page, 10, accessToken)
