...
-- ----------------------------
INSERT INTO `blog_category` VALUES (1, 'default', '默认分类', 1);
...
CREATE TABLE `kitbox_icp_cache` (
  ...
  `leader_name` varchar(2048) DEFAULT NULL COMMENT '负责人名称',
  `limit_access` varchar(255) DEFAULT NULL COMMENT '是否限制接入',
...
-- ----------------------------
INSERT INTO `leaf_alloc` VALUES ('leaf-segment-global', 1006000, 20, 'Segment Mode Get Id', '2021-11-12 05:36:43');
...
-- ----------------------------
INSERT INTO `QRTZ_CRON_TRIGGERS` VALUES ('quartzScheduler', 'UpdateBlogPageRankJob', 'SystemTimedTask', '0 30 2 * * ? ', 'Asia/Shanghai');
INSERT INTO `QRTZ_CRON_TRIGGERS` VALUES ('quartzScheduler', 'UpdateSearchEngineJob', 'SystemTimedTask', '0 30 3 * * ? ', 'Asia/Shanghai');
...
-- ----------------------------
INSERT INTO `QRTZ_JOB_DETAILS` VALUES ('quartzScheduler', 'UpdateBlogPageRankJob', 'SystemTimedTask', NULL, 'net.renfei.services.jobs.UpdateBlogPageRankJob', '0', '0', '0', '0', );
INSERT INTO `QRTZ_JOB_DETAILS` VALUES ('quartzScheduler', 'UpdateSearchEngineJob', 'SystemTimedTask', NULL, 'net.renfei.services.jobs.UpdateSearchEngineJob', '0', '0', '0', '0', );
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('quartzScheduler', 'UpdateBlogPageRankJob', 'SystemTimedTask', 'UpdateBlogPageRankJob', 'SystemTimedTask', NULL, 1641580200000, -1, 5, 'WAITING', 'CRON', 1641570265000, 0, NULL, 0, '');
...
INSERT INTO `sys_account_role` VALUES (2, 3, 2);
INSERT INTO `sys_account_role` VALUES (3, 4, 3);
...
CREATE TABLE `sys_logs` (
  ...
  `requ_uri` varchar(2048) DEFAULT NULL COMMENT '请求URI',
  `requ_referrer` varchar(2048) DEFAULT NULL COMMENT '引荐地址',
...
-- ----------------------------
INSERT INTO `sys_site_menu` VALUES (1, NULL, '首页', '/', 0, 1, 0);
INSERT INTO `sys_site_menu` VALUES (2, NULL, '文章', '/posts', 0, 1, 1);
INSERT INTO `sys_site_menu` VALUES (3, NULL, '视频', '/video', 0, 1, 3);
INSERT INTO `sys_site_menu` VALUES (4, NULL, '相册', '/photo', 0, 1, 4);
INSERT INTO `sys_site_menu` VALUES (5, NULL, '工具箱', '/kitbox', 0, 1, 6);
INSERT INTO `sys_site_menu` VALUES (6, NULL, '更多', 'JavaScript:void(0);', 0, 1, 9999);
INSERT INTO `sys_site_menu` VALUES (7, 6, '关于', '/about', 0, 1, 0);
INSERT INTO `sys_site_menu` VALUES (8, 6, 'NiFi Docs', 'https://www.renfei.net/docs/Apache/NiFi/1.13.0/zh', 1, 1, 2);
INSERT INTO `sys_site_menu` VALUES (9, 6, 'OpenAPI', '/swagger-ui/index.html', 1, 1, 3);
