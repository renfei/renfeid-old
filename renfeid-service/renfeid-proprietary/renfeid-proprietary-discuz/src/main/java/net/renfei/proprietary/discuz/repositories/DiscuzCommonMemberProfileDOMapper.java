...
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberProfileDO;
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberProfileDOExample;
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberProfileDOWithBLOBs;
