...
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonUsergroupDO;
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonUsergroupDOExample;
