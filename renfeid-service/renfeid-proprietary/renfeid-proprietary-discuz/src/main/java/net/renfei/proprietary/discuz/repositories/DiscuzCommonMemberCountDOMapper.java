...
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberCountDO;
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberCountDOExample;
