...
import net.renfei.pro.discuz.repositories.entity.DiscuzCommonMemberProfileDO;
import net.renfei.pro.discuz.repositories.entity.DiscuzCommonMemberProfileDOExample;
import net.renfei.pro.discuz.repositories.entity.DiscuzCommonMemberProfileDOWithBLOBs;
