...
public class VideoHandler extends AbstractHandler {
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMpXmlMessage,
        ...
        logger.info("微信用户发送了语音，无法处理MediaId：{}，ThumbMediaId：{}",
                wxMpXmlMessage.getMediaId(), wxMpXmlMessage.getThumbMediaId());
        return new TextBuilder()
                .build("我们收到了您的视频消息，但我们目前暂时无法处理，请尝试文字输入。", wxMpXmlMessage, wxMpService);
    }
}
