...
public class DiscuzCommonMemberProfileDO {
    private Integer uid;
    ...
    public void setBirthdist(String birthdist) {
        this.birthdist = birthdist == null ? null : birthdist.trim();
    }
    ...
    public void setBirthcommunity(String birthcommunity) {
        this.birthcommunity = birthcommunity == null ? null : birthcommunity.trim();
    }
    ...
    public void setResidecommunity(String residecommunity) {
        this.residecommunity = residecommunity == null ? null : residecommunity.trim();
    }
    ...
    public void setResidesuite(String residesuite) {
        this.residesuite = residesuite == null ? null : residesuite.trim();
    }
