...
<@compress single_line=true>
    ...
    <div class="container" style="font-size: 14px;">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        GitHub:<a href="https://github.com/renfei" target="_blank" rel="nofollow noopener">GitHub</a>
                        <br>
                        Gitee:<a href="https://gitee.com/rnf" target="_blank" rel="nofollow noopener">Gitee</a> <br>
                        GitLab:<a href="https://gitlab.com/renfei" target="_blank" rel="nofollow noopener">GitLab</a>
                        <br>
                        Facebook:<a href="https://www.facebook.com/renfeii" target="_blank"
                                    rel="nofollow noopener">任霏</a> <br>

                    </div>
                    <div class="col-sm-6">
                        Sina Weibo:<a href="https://weibo.com/5214619228" target="_blank"
                                      rel="nofollow noopener">任霏博客网</a> <br>
                        Twitter:<a href="https://twitter.com/renfeii" target="_blank"
                                   rel="nofollow noopener">@renfeii</a> <br>
        ...
        <div class="row mt-5">
            ...
            <div class="col-12">
                添加 SSH Key 脚本命令：mkdir -p ~/.ssh; echo $(curl -s "https://cdn.renfei.net/public/ssh/id_dsa.pub") >>
                ~/.ssh/authorized_keys;
            </div>
        </div>
    </div>
