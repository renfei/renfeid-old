package net.renfei.domain.ip2location;
...
public class IPResult {
    ...
    public String toString() {
        ...
        buf.append("\tIP Address = ").append(ip_address).append(NL);
        buf.append("\tCountry Short = ").append(country_short).append(NL);
        buf.append("\tCountry Long = ").append(country_long).append(NL);
        buf.append("\tRegion = ").append(region).append(NL);
        buf.append("\tCity = ").append(city).append(NL);
        buf.append("\tISP = ").append(isp).append(NL);
        buf.append("\tLatitude = ").append(latitude).append(NL);
        buf.append("\tLongitude = ").append(longitude).append(NL);
        buf.append("\tDomain = ").append(domain).append(NL);
        buf.append("\tZipCode = ").append(zipcode).append(NL);
        buf.append("\tTimeZone = ").append(timezone).append(NL);
        buf.append("\tNetSpeed = ").append(netspeed).append(NL);
        buf.append("\tIDDCode = ").append(iddcode).append(NL);
        buf.append("\tAreaCode = ").append(areacode).append(NL);
        buf.append("\tWeatherStationCode = ").append(weatherstationcode).append(NL);
        buf.append("\tWeatherStationName = ").append(weatherstationname).append(NL);
        buf.append("\tMCC = ").append(mcc).append(NL);
        buf.append("\tMNC = ").append(mnc).append(NL);
        buf.append("\tMobileBrand = ").append(mobilebrand).append(NL);
        buf.append("\tElevation = ").append(elevation).append(NL);
        buf.append("\tUsageType = ").append(usagetype).append(NL);
        buf.append("\tAddressType = ").append(addresstype).append(NL);
        buf.append("\tCategory = ").append(category).append(NL);
        return buf.toString();
    }
}
