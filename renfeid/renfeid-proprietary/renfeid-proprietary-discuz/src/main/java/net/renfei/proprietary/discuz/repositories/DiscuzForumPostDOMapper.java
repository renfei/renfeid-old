...
import net.renfei.proprietary.discuz.repositories.entity.DiscuzForumPostDOExample;
import net.renfei.proprietary.discuz.repositories.entity.DiscuzForumPostDOKey;
