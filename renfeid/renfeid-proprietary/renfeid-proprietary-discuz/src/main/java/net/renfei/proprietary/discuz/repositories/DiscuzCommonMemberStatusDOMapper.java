...
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberStatusDO;
import net.renfei.proprietary.discuz.repositories.entity.DiscuzCommonMemberStatusDOExample;
